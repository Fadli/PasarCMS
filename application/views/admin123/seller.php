           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu" href="<?=site_url()?>/admin123/seller"><i class="fa fa-desktop fa-3x"></i>Data Pedagang</a>
                    </li>
						   <li  >
                        <a   href="<?=site_url()?>/admin123/transaction"><i class="fa fa-bar-chart-o fa-3x"></i>Data Transaksi</a>
                    </li>	
                    <li  >
                        <a  href="<?=site_url()?>/admin123/pasar"><i class="fa fa-table fa-3x"></i>Data Pasar</a>
                    </li>			
                    <li  >
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                       <?php $no=1; foreach($seller as $itemseller) { ?>
                                        <tr class="odd gradeX">
                                            <td><?=$no++?></td>
                                            <td><?=$itemseller->sellername?></td>
                                            <td><?=$itemseller->owner?></td>
                                            <td><?=$itemseller->address?></td>
                                            <td><?php if($itemseller->status==1) { echo "Aktif"; } else { echo "Non Aktif"; } ?></td>
                                            <td class="center">Edit | Delete | <a href="http://pasardepok.com/sendemail/ea9105682d1873a459490e96ceaa1019.php?name=<?=$itemseller->sellername?>&iduser=<?=$itemseller->idseller?>&email=<?=$itemseller->email?>&password=<?=$itemseller->showpassword?>">Send</a></td>
                                        </tr>
                                    <?php } ?>
