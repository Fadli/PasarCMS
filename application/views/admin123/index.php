...
<head>
    ...
    <link href="<?=base_url()?>assets/assetsadmin/css/font-awesome.css" rel="stylesheet" />
     <!-- MORRIS CHART STYLES-->
    <link href="<?=base_url()?>assets/assetsadmin/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=site_url()?>"><?=$web->logo?></a> 
            </div>
...
font-size: 16px;"> Last access : 29 Oktober 2015 &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="<?=site_url()?>/admin123/dashboard"><i class="fa fa-dashboard fa-3x"></i>Dashboard</a>
                    </li>
                     <li>
        ...
        <div id="page-wrapper" >
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">30 Total</p>
                    <p class="text-muted">Pedagang</p>
                </div>
             </div>
		     </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">           
                            ...
                            <ul class="chat-box">
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src="<?=base_url()?>/assets/assetsadmin/img/1.png" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body">                                        
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                        ...
                                        <img src="<?=base_url()?>/assets/assetsadmin/img/2.png" alt="User" class="img-circle" />
                                    </span>
                                ...
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                         <img src="<?=base_url()?>/assets/assetsadmin/img/3.png" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                         <img src="<?=base_url()?>/assets/assetsadmin/img/4.png" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
...
<span class="label label-danger">Danger</span>
    ...
    <script src="<?=base_url()?>assets/assetsadmin/js/jquery.metisMenu.js"></script>
     ...
     <script src="<?=base_url()?>assets/assetsadmin/js/morris/raphael-2.1.0.min.js"></script>
    <script src="<?=base_url()?>assets/assetsadmin/js/morris/morris.js"></script>
      <!-- CUSTOM SCRIPTS -->
