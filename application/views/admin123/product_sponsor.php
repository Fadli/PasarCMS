           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li  >
                        <a  class="active-menu" href="<?=site_url()?>/admin123/produksponsor"><i class="fa fa-table fa-3x"></i>Produk Sponsor</a>
                    </li>			
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="#">Input Produk </a>| Data Produk Sponsor
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php $no=1; foreach($product as $itemproduct) { ?>
                                        <tr class="odd gradeX">
                                            <td><?=$no++?></td>
                                            <td><?=$itemproduct->product_name?></td>
                                            <td><?=$itemproduct->sponsor_name?></td>
                                            <td class="center"><?=$itemproduct->price?></td>
