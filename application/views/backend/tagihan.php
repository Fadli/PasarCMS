                        ...
                        <div class="col-md-9 col-sm-9">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Informasi Donasi</h4>
                                </div>
                                <div class="panel-body">
                                    <div class="before-table">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <a href="#" class="btn btn-custom"><i class="fa fa-plus"></i> Konfirmasi SMS : 081290094377</a>
                                            </div>
                                            <div class="col-xs-6">
                                    ...
                                    <table width="100%" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="40%">Nama Donasi</th>
                                                <th width="37%">Nomor Rekening</th>
                                                <th width="21%">Jumlah</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td><input type="checkbox"></td>
                                                <td>Donasi Operasional Sistem 1 tahun</td>
                                                <td>Mandiri : <br>
                                                	BRI	: 
                                                </td>
                                                <td>100.000</td>
