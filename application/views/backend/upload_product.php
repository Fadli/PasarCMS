                        ...
                        <div class="col-md-9 col-sm-9">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"> <a href="#collapseB1" data-toggle="collapse"> Produk Baru </a> </h4>
                                </div>
                                <?php if($this->uri->segment(3)=="sukses") { ?>
                                <span style="background-color:#58b325; width:100%; padding:5px; text-align:center; height:100px; color:#FFF">
                                Produk Berhasil di Tambahkan</span>
                                <?php } ?>
                                 <form action="<?=site_url()?>/A418c5509e2171d55b0aee5c2ea4442b5/upload_product" method="post" enctype="multipart/form-data">
                                 
                                    <div class="panel-body">             
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Nama Produk</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="nama_produk" required="required" class="form-control">                                   			</div>
                                        </div><br>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" name="harga" min="1" required="required" class="form-control">                                
                                            </div>
                                        </div><br>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">Stok</label>
                                            <div class="col-sm-9">
                                                <input type="number" name="stok" min="1" required="required" class="form-control">                                
                                            </div>
                                        </div><br>
                                        <div class="form-group">
