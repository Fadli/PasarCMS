            ...
            <div class="category-search">
                <div class="container">
                    <div class="row category-search-box">
                    	<img src="<?=base_url()?>assets/images/seller/<?=$pasar->fotopasar?>" width="200" height="200" hspace="10" align="left">
                        <u>Nama Pasar</u> <br>
						<?=$pasar->pasarname?><br>
                        <u>Alamat </u><br>
						<?=$pasar->address?> 
                        <p><u>Profil Singkat </u></p>
                        <p><?=$pasar->profile?></p>
                  </div>
                </div>
            </div>
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <ul class="trends">
										<?php foreach($kategori as $itemcategory) { ?>
