                                    <?php
                                     ...
                                     $seller=$this->db->where('idseller',$product->idseller);
									 $seller=$this->db->get('data_seller')->row();
									?>
<!DOCTYPE html>
<html>  
    <head>
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="post-meta">
                                            <ul>
                                                ...
                                                <li><i class="fa fa-map-marker"></i> <a href="#"><?=$product->pasarname?></a></li>
                                        ...
                                        <div class="post-footer">
                                            <div class="row">
                                                <div class="col-xs-6">    
                                                    ...
                                                    <button class="btn btn-warning" data-target="#sendMessageModal" data-toggle="modal"><i class="fa fa-cart-plus"></i> <span class="hidden-xs hidden-sm">Pesan Cepat</span></button>
                                                </div>
                                                <div class="col-xs-6">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="widget">
                                ...
                                <div class="widget-body text-center">
                                    <img alt="avatar" src="<?=base_url()?>assets/images/seller/<?=$seller->avatar?>" class="seller-avatar img-responsive">
                                    <h2 class="seller-name"><?=$seller->sellername?></h2>
                                    <p class="seller-detail">Lokasi: <strong><?=$seller->pasarname?></strong><br/>
                                        Bergabung sejak : <strong><?=$seller->date?></strong></p>
                                </div>
                                <div class="widget-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <button class="btn btn-warning btn-block" data-target="#sendMessageModal" data-toggle="modal"><i class="fa fa-cart-plus"></i> Pesan Cepat</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 id="sendMessageModalLabel" class="modal-title">Pesan Cepat</h4>
                    </div>
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="message-text">Isi Pesan:</label>
